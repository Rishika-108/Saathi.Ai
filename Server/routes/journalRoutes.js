...
import { getUserAnalysis, getUserPersonalityCard } from '../controllers/dashboardController.js';
...
journalRouter.get("/get-user-personality", authMiddleware, getUserPersonalityCard);
